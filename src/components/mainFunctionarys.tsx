...
export function MainFunctionarys({ data}:any) {
  ...
  return (
    ...
    <Typography variant="h1" className="p-2 rounded-lg bg-blue-500 text-white max-w-[400px] text-center">
      ...
      <div className="min-w-full max-w-full flex flex-col items-center justify-center">
        <div className="min-w-[70%] max-w-full lg:max-w-[70%] flex justify-center items-center gap-2 my-6">
        ...
        <div className="min-w-full max-w-full flex gap-2 flex-col md:flex-row flex-wrap lg:justify-end lg:items-center">
      ...
      {
          dataSearch && (
      <Card className="overflow-scroll min-w-full max-w-full flex jusify-center my-8">
      <table className="text-center">
        ...
        <div className="mt-8 max-h-[600px] min-w-[90%] max-w-full flex justify-center items-center">
        {
            typeChart === "Bar"? (
        ...
        <div className="mx-4 my-6 min-w-[90%] max-w-[90%] flex justify-center items-center">
        <Card className="overflow-scroll min-w-full max-w-full flex jusify-center">
      <table className="text-center">
        <thead>
          <tr>
            {tableHeard.map((head) => (
